...
print(f"There are a total of {total_num_of_loans} loans.")
...
print(f"The sum total value of the loans is {total_value_of_loans}")
...
# YOUR CODE HERE!
average_loan_price = total_value_of_loans / total_num_of_loans
...
# discount rate -- 20% minimum required
discount_rate = .2
...
if present_value >= cost:
    print(f'Good value, the loan price of {cost} is worth at least the cost to buy it!')
else:
    print(f"The loan price of {cost} is too expensive. Not worth the price.")
...
# inputs: future_value, remaining months, annual_discount_rate
...
# YOUR CODE HERE!
# list to store the inexpensive loans
inexpensive_loans = []
...
# YOUR CODE HERE!
# inspecting the list of inespensive loans
